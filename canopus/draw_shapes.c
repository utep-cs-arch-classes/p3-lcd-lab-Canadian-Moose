...
void safeZones(void){
  ...
  drawChar8x12(14, 15, 'r', COLOR_PURPLE, COLOR_PALE_GREEN);
  drawChar8x12(23, 15, 'o', COLOR_PURPLE, COLOR_PALE_GREEN);
  drawChar8x12(32, 15, 'g', COLOR_PURPLE, COLOR_PALE_GREEN);
  drawChar8x12(41, 15, 'g', COLOR_PURPLE, COLOR_PALE_GREEN);
  drawChar8x12(50, 15, 'e', COLOR_PURPLE, COLOR_PALE_GREEN);
  drawChar8x12(59, 15, 'r', COLOR_PURPLE, COLOR_PALE_GREEN);
}
